...
actual hardware. CONNECTOR_OVERHANG and USB_SILL_HEIGHT are still estimates
— test-fit before committing to a full print, and adjust the constants if
your board variant differs.
"""
